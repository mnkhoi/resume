...
\begin{rSection}{Skills}
	...
	\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
		...
		Frameworks and Technologies & Go-Chi, Express.js, Node.js, MySQL, PostgreSQL, Linux/Unix, CUDA \\
...
\begin{rSection}{Work Experience}
	...
	\item Improved on LSF statistical dashboard using \textbf{Go}, \textbf{Svelte/Sveltekit}, and \textbf{Ruby} for managing jobs running on IBM Spectrum LSF.
	\item Designed and implemented the 'Matrix' automation framework in \textbf{Go}, and \textbf{MySQL} to speed up work and allow for running tests through chat or email.
	\item Assisted in running and managing regression
	\end{rSubsection}
