...
\begin{rSection}{Skills}
	\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
		...
		Frameworks and Technologies & Go-Chi, Express.js/Node.js, FastAPI, MySQL, PostgreSQL, SQLite3, Unix, CUDA \\
		...
		Tools & git, perforce, jenkins, docker, gdb, valgrind, gcc, Agile methodologies\\
