...
\begin{rSection}{Education}
	...
	\begin{itemize}
		\item \textbf{Relevant Courses}: Software Design, Probability and Statistics I, Introduction to Theory of Computation, Software Tools and Systems Programming, Data Structures and Analysis, Operating Systems, Parallel Programming
	\end{itemize}
\end{rSection}
%----------------------------------------------------------------------------------------
...
\begin{rSection}{Skills}
	...
	\begin{tabular}{@{} >{\bfseries}l @{\hspace{6ex}} l @{}}
		Computer Languages & Java, Python, C/C++, Javascript, SQL, Shell, Bash, Perl \\
