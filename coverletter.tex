...
\begin{document}
    ...
    \medskip
    \coverhead{Intuit}{8 Spadina Ave. , Suite 1900, Toronto , Ontario , Canada, M5V 0S8}{Hiring Manager}
    
    I am excited to apply for the Software Developer Intern opportunity in Intuit Engineering's team as seen on the UofT's Engineering job board. I am currently a third-year Computer Science specialist in the PEY Co-op program at the University of Toronto Mississauga. From my studies so far, I have learnt a strong understanding of object-oriented programing, data structures and computer infrastructure, and am looking forward to learning about new technologies to improve myself. As someone who is interested in exploring new technologies that pushes the limit, Intuit is the perfect as it values innovation and includes diversity. The Software Developer Intern position would allow me to build upon what I have learnt at school while contributing my knowledge, skills, and unique outlook to help drive innovation in your company.
    ...
    I am an innovative problem-solver, effective communicator and curious learner, eager to take on new challenges and contribute to Intuit's mission. Thank you for taking the time to review my application. I look forward to hearing from you and can be contacted via email (\href{mailto:mnkhoi.nguyen@mail.utoronto.ca}{mnkhoi.nguyen@mail.utoronto.ca}) to discuss this co-op opportunity in further detail.
